...
METRIC_WORDS: list[tuple[str, tuple[str, ...]]] = [
    ...
    ("qty", ("销量", "卖了多少份", "多少份", "多少杯", "多少碗", "多少件", "卖出", "售出", "销售数量", "卖得最多", "卖的最多", "卖得最少", "卖的最少")),
...
RANK_WORDS = ("最高", "最多", "最好", "最差", "第一", "top", "排名", "最畅销", "卖得最好", "最低", "最少")
#: 排名问的是“垫底”的那一头。
...
SALES_RANK_WORDS = ("卖得最好", "卖的最好", "最畅销", "卖得最多", "卖的最多", "销量最高", "最好卖", "卖得最差", "卖的最差", "卖得最少", "卖的最少", "销冠")
